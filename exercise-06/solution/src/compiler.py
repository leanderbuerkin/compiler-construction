...
from pass_3_3_limit_functions import limit
from pass_3_4_alloc import alloc
from pass_4_5_monadic import monadic
from pass_5_6_explicate import explicate
from pass_6_7_select import select
from pass_7_8_assign_homes import assign_homes
from pass_8_9_patch_instructions import patch_instructions
from pass_9_10_add_prelude import add_prelude_and_conclusion
...
ast = alloc(ast)
if verbose:
    print(ast_4_alloc.pretty(ast))

if verbose:
    print("\n===== MONADIC NORMALFORM =====\n")
ast = monadic(ast)
if verbose:
    print(ast_5_mon.pretty(ast))

if verbose:
    print("\n===== EXPLICATE CONTROL =====\n")
blocks = explicate(ast)
if verbose:
    print(ast_6_exp.pretty(blocks))

if verbose:
    print("\n===== INSTRUCTION SELECTION =====\n")
blocks = select(blocks)
if verbose:
    print(ast_7_sel.pretty(blocks))
...
if verbose:
    print(ast_8_mem.pretty(ast))

if verbose:
    print("\n===== PATCH INSTRUCTIONS =====\n")
ast = patch_instructions(ast)
if verbose:
    print(ast_9_patched.pretty(ast))

if verbose:
    print("\n===== ADD PRELUDE & CONCLUSION =====\n")
ast = add_prelude_and_conclusion(ast, reg_allocs)
if verbose:
    print(ast_10_riscv.pretty(ast))

tgt_str = ast_10_riscv.pretty(ast)
